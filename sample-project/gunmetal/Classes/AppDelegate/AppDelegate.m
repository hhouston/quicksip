...
{
    [Parse setApplicationId:@"UJo9cf0nJqR5tbZu7I3QfFYdBdrx3w4FujpAkNQm"
                  clientKey:@"eCEKtowI39PTxi0DpcWfFPh3R9UbmScf0HvjxynZ"];
...
-(void)configureiPhoneTabBar
{
    ...
    [self configureTabBarItemWithImageName:@"tab-icon1.png" andText:@"Profile" forViewController:controller1];
    
    
    UIViewController *controller2 = [tabBarController viewControllers][1];
    [self configureTabBarItemWithImageName:@"tab-icon2.png" andText:@"Venues" forViewController:controller2];
    
    
    UIViewController *controller3 = [tabBarController viewControllers][2];
    [self configureTabBarItemWithImageName:@"tab-icon3.png" andText:@"Order" forViewController:controller3];
    
    
    UIViewController *controller4 = [tabBarController viewControllers][3];
    [self configureTabBarItemWithImageName:@"tab-icon4.png" andText:@"Stats" forViewController:controller4];
